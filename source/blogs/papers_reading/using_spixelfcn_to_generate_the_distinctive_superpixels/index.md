...
The author did not stop at this point but tried to continue to optimize the network structure. Since the full convolutional network couldn't lean smoothness of the image, the author introduced the Spatial Propagation (SP) proposed in NIPS2017 "Learning Affinity via Spatial Propagation Networks". Because of building affinity matrix to propagate information in the full convolutional network, the author called Convolutional Spatial Propagation (CSP). As is the following formula:
